...
bool MyApp::OnInit()
{
    ...
    MyFrame *frame = new MyFrame(wxT_2("wxSplashScreen sample application"));
    ...
    bool ok = frame->m_isPda
            ? bitmap.IsOk()
            : bitmap.LoadFile(wxT_2("splash.png"), wxBITMAP_TYPE_PNG);
       ...
       : wxFrame(NULL, wxID_ANY, title)
{
    ...
    helpMenu->Append(wxID_ABOUT, wxT_2("&About\tF1"), wxT_2("Show about frame"));

    menuFile->Append(wxID_EXIT, wxT_2("E&xit\tAlt-X"), wxT_2("Quit this program"));
...
#if wxUSE_MEDIACTRL
        wxMediaCtrl *media = new wxMediaCtrl( win, wxID_EXIT, wxT_2("press.mpg"), wxPoint(2,2));
        media->Play();
#else
        wxStaticText *text = new wxStaticText( win,
                                               wxID_EXIT,
                                               wxT_2("click somewhere\non this image"),
