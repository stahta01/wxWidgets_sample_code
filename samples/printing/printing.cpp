...
bool MyApp::OnInit(void)
{
    ...
    MyFrame* frame = new MyFrame((wxFrame *) NULL, wxT_2("wxWidgets Printing Demo"),
...
void MyApp::Draw(wxDC&dc)
{
    ...
    dc.DrawText( wxT_2("Rectangle 200 by 80"), 40, 40);

    dc.SetPen( wxPen(*wxBLACK, 0, wxPENSTYLE_DOT_DASH) );
    dc.DrawEllipse(50, 140, 100, 50);
    dc.SetPen(*wxRED_PEN);

    dc.DrawText( wxT_2("Test message: this is in 10 point text"), 10, 180);
    ...
    wxString str;
    int i = 0;
    str.Printf( wxT_2("---- Text at angle %d ----"), i );
        ...
        : wxFrame(frame, wxID_ANY, title, pos, size)
{
    ...
    CreateStatusBar(2);
    SetStatusText(wxT_2("Printing demo"));
    ...
    file_menu->Append(wxID_PRINT, wxT_2("&Print..."),                 wxT_2("Print"));
    file_menu->Append(WXPRINT_PAGE_SETUP, wxT_2("Page Set&up..."),    wxT_2("Page setup"));
#ifdef __WXMAC__
    file_menu->Append(WXPRINT_PAGE_MARGINS, wxT_2("Page Margins..."), wxT_2("Page margins"));
#endif
    file_menu->Append(wxID_PREVIEW, wxT_2("Print Pre&view"),          wxT_2("Preview"));
    ...
    file_menu->Append(WXPRINT_PRINT_PS, wxT_2("Print PostScript..."),           wxT_2("Print (PostScript)"));
    file_menu->Append(WXPRINT_PAGE_SETUP_PS, wxT_2("Page Setup PostScript..."), wxT_2("Page setup (PostScript)"));
    file_menu->Append(WXPRINT_PREVIEW_PS, wxT_2("Print Preview PostScript"),    wxT_2("Preview (PostScript)"));
#endif

    file_menu->AppendSeparator();
    file_menu->Append(WXPRINT_ANGLEUP, wxT_2("Angle up\tAlt-U"),                wxT_2("Raise rotated text angle"));
    file_menu->Append(WXPRINT_ANGLEDOWN, wxT_2("Angle down\tAlt-D"),            wxT_2("Lower rotated text angle"));
    file_menu->AppendSeparator();
    file_menu->Append(wxID_EXIT, wxT_2("E&xit"),                                wxT_2("Exit program"));

    wxMenu *help_menu = new wxMenu;
    help_menu->Append(wxID_ABOUT, wxT_2("&About"),                              wxT_2("About this demo"));

    wxMenuBar *menu_bar = new wxMenuBar;

    menu_bar->Append(file_menu, wxT_2("&File"));
    menu_bar->Append(help_menu, wxT_2("&Help"));
...
void MyFrame::OnPrint(wxCommandEvent& WXUNUSED(event))
{
    ...
    MyPrintout printout(this, wxT_2("My printout"));
    if (!printer.Print(this, &printout, true /*prompt*/))
    {
        if (wxPrinter::GetLastError() == wxPRINTER_ERROR)
        {
            wxLogError(wxT_2("There was a problem printing. Perhaps your current printer is not set correctly?"));
        }
        else
        {
            wxLogMessage(wxT_2("You canceled printing"));
        }
    }
    else
    {
...
void MyFrame::OnPrintPreview(wxCommandEvent& WXUNUSED(event))
{
    ...
    {
        delete preview;
        wxLogError(wxT_2("There was a problem previewing.\nPerhaps your current printer is not set correctly?"));
        return;
    }

    wxPreviewFrame *frame =
        new wxPreviewFrame(preview, this, wxT_2("Demo Print Preview"), wxPoint(100, 100), wxSize(600, 650));
    frame->Centre(wxBOTH);
...
{
    (void)wxMessageBox(wxT_2("wxWidgets printing demo\nAuthor: Julian Smart"),
                       wxT_2("About wxWidgets printing demo"), wxOK|wxCENTRE);
}
...
bool MyPrintout::OnPrintPage(int page)
{
    ...
    if (dc)
    {
        ...
        dc->DrawText(wxString::Format(wxT_2("PAGE %d"), page), 0, 0);
...
void MyPrintout::DrawPageTwo()
{
    ...
    { // GetTextExtent demo:
        wxString words[7] = { wxT_2("This "), wxT_2("is "), wxT_2("GetTextExtent "),
                             wxT_2("testing "), wxT_2("string. "), wxT_2("Enjoy "), wxT_2("it!") };
        long x = 200, y= 250;
    ...
    dc->DrawText(wxT_2("Some test text"), 200, 300 );
    ...
    WritePageHeader(this, dc, wxT_2("A header"), logUnitsFactor);
}
