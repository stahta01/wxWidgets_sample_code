...
bool DXFRenderer::ParseHeader(wxInputStream& stream)
{
    ...
    while (stream.CanRead())
    {
        ...
        if (line1 == wxT_2("0") && line2 == wxT_2("ENDSEC"))
            return true;
    }
    return false;
}
...
bool DXFRenderer::ParseTables(wxInputStream& stream)
{
    ...
    while (stream.CanRead())
    {
        ...
        if (line1 == wxT_2("0") && line2 == wxT_2("ENDSEC"))
            return true;
        else if (line1 == wxT_2("0") && line2 == wxT_2("LAYER"))
            inlayer = true;
        else if (inlayer)
        {
            if (line1 == wxT_2("2")) // layer name
                layer.name = line2;
            else if (line1 == wxT_2("62")) // ACI colour
            {
                long l;
                line2.ToLong(&l);
                layer.colour = l;
...
bool DXFRenderer::ParseEntities(wxInputStream& stream)
{
    ...
    while (stream.CanRead())
    {
        ...
        if (line1 == wxT_2("0") && line2 == wxT_2("ENDSEC"))
            return true;
        else if (line1 == wxT_2("0") && line2 == wxT_2("3DFACE"))
            state = 1;
        else if (line1 == wxT_2("0") && line2 == wxT_2("LINE"))
            state = 2;
        else if (state > 0)
        {
            ...
            if (line1 == wxT_2("10"))
                v[0].x = d;
            else if (line1 == wxT_2("20"))
                v[0].y = d;
            else if (line1 == wxT_2("30"))
                v[0].z = d;
            else if (line1 == wxT_2("11"))
                v[1].x = d;
            else if (line1 == wxT_2("21"))
                v[1].y = d;
            else if (line1 == wxT_2("31"))
                v[1].z = d;
            else if (line1 == wxT_2("12"))
                v[2].x = d;
            else if (line1 == wxT_2("22"))
                v[2].y = d;
            else if (line1 == wxT_2("32"))
                v[2].z = d;
            else if (line1 == wxT_2("13"))
                v[3].x = d;
            else if (line1 == wxT_2("23"))
                v[3].y = d;
            else if (line1 == wxT_2("33"))
                v[3].z = d;
            else if (line1 == wxT_2("8"))  // layer
                layer = line2;
            else if (line1 == wxT_2("62")) // colour
            {
                long l;
                line2.ToLong(&l);
                colour = l;
...
bool DXFRenderer::Load(wxInputStream& stream)
{
    ...
    {
        GetLines(text, line1, line2);
        if (line1 == wxT_2("999")) // comment
            continue;
        else if (line1 == wxT_2("0") && line2 == wxT_2("SECTION"))
        {
            GetLines(text, line1, line2);
            if (line1 == wxT_2("2"))
            {
                if (line2 == wxT_2("HEADER"))
                {
                    if (!ParseHeader(stream))
                        return false;
                }
                else if (line2 == wxT_2("TABLES"))
                {
                    if (!ParseTables(stream))
                        return false;
                }
                else if (line2 == wxT_2("ENTITIES"))
                {
