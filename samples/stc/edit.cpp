...
Edit::Edit (wxWindow *parent, wxWindowID id,
    ...
    StyleSetForeground (wxSTC_STYLE_LINENUMBER, wxColour (wxT_2("DARK GREY")));
    StyleSetBackground (wxSTC_STYLE_LINENUMBER, *wxWHITE);
    StyleSetForeground(wxSTC_STYLE_INDENTGUIDE, wxColour (wxT_2("DARK GREY")));
    ...
    // markers
    MarkerDefine (wxSTC_MARKNUM_FOLDER,        wxSTC_MARK_DOTDOTDOT, wxT_2("BLACK"), wxT_2("BLACK"));
    MarkerDefine (wxSTC_MARKNUM_FOLDEROPEN,    wxSTC_MARK_ARROWDOWN, wxT_2("BLACK"), wxT_2("BLACK"));
    MarkerDefine (wxSTC_MARKNUM_FOLDERSUB,     wxSTC_MARK_EMPTY,     wxT_2("BLACK"), wxT_2("BLACK"));
    MarkerDefine (wxSTC_MARKNUM_FOLDEREND,     wxSTC_MARK_DOTDOTDOT, wxT_2("BLACK"), wxT_2("WHITE"));
    MarkerDefine (wxSTC_MARKNUM_FOLDEROPENMID, wxSTC_MARK_ARROWDOWN, wxT_2("BLACK"), wxT_2("WHITE"));
    MarkerDefine (wxSTC_MARKNUM_FOLDERMIDTAIL, wxSTC_MARK_EMPTY,     wxT_2("BLACK"), wxT_2("BLACK"));
    MarkerDefine (wxSTC_MARKNUM_FOLDERTAIL,    wxSTC_MARK_EMPTY,     wxT_2("BLACK"), wxT_2("BLACK"));

    // annotations
    AnnotationSetVisible(wxSTC_ANNOTATION_BOXED);

    // miscellaneous
    m_LineNrMargin = TextWidth (wxSTC_STYLE_LINENUMBER, wxT_2("_999999"));
    m_FoldingMargin = 16;
...
bool Edit::InitializePrefs (const wxString &name) {
    ...
    // set common styles
    StyleSetForeground (wxSTC_STYLE_DEFAULT, wxColour (wxT_2("DARK GREY")));
    StyleSetForeground (wxSTC_STYLE_INDENTGUIDE, wxColour (wxT_2("DARK GREY")));
    ...
    if (g_CommonPrefs.foldEnable) {
        ...
        SetProperty (wxT_2("fold.comment"),
                     (curInfo->folds & mySTC_FOLD_COMMENT) > 0? wxT_2("1"): wxT_2("0"));
        SetProperty (wxT_2("fold.compact"),
                     (curInfo->folds & mySTC_FOLD_COMPACT) > 0? wxT_2("1"): wxT_2("0"));
        SetProperty (wxT_2("fold.preprocessor"),
                     (curInfo->folds & mySTC_FOLD_PREPROC) > 0? wxT_2("1"): wxT_2("0"));
        SetProperty (wxT_2("fold.html"),
                     (curInfo->folds & mySTC_FOLD_HTML) > 0? wxT_2("1"): wxT_2("0"));
        SetProperty (wxT_2("fold.html.preprocessor"),
                     (curInfo->folds & mySTC_FOLD_HTMLPREP) > 0? wxT_2("1"): wxT_2("0"));
        SetProperty (wxT_2("fold.comment.python"),
                     (curInfo->folds & mySTC_FOLD_COMMENTPY) > 0? wxT_2("1"): wxT_2("0"));
        SetProperty (wxT_2("fold.quotes.python"),
                     (curInfo->folds & mySTC_FOLD_QUOTESPY) > 0? wxT_2("1"): wxT_2("0"));
    }
...
bool Edit::LoadFile ()
{
    ...
    // get filename
    if (!m_filename) {
        wxFileDialog dlg (this, wxT_2("Open file"), wxEmptyString, wxEmptyString,
...
bool Edit::SaveFile ()
{
    ...
    // get filename
    if (!m_filename) {
        wxFileDialog dlg (this, wxT_2("Save file"), wxEmptyString, wxEmptyString, wxT_2("Any file (*)|*"),
...
EditProperties::EditProperties (Edit *edit,
    ...
    switch (edit->GetEOLMode()) {
        case wxSTC_EOL_CR: {EOLtype = wxT_2("CR (Unix)"); break; }
        case wxSTC_EOL_CRLF: {EOLtype = wxT_2("CRLF (Windows)"); break; }
        case wxSTC_EOL_LF: {EOLtype = wxT_2("CR (Macintosh)"); break; }
    }
