...
IMPLEMENT_WIDGETS_PAGE(CheckBoxWidgetsPage, wxS("CheckBox"), FAMILY_CTRLS );
...
void CheckBoxWidgetsPage::CreateContent()
{
    ...
    {
        wxT_2("usual &2-state checkbox"),
        wxT_2("&3rd state settable by program"),
        wxT_2("&user-settable 3rd state"),
    };

    m_radioKind = new wxRadioBox(this, wxID_ANY, wxT_2("&Kind"),
                                 wxDefaultPosition, wxDefaultSize,
                                 WXSIZEOF(kinds), kinds,
                                 1);
    sizerLeft->Add(m_radioKind, 0, wxGROW | wxALL, 5);
    wxButton *btn = new wxButton(this, CheckboxPage_Reset, wxT_2("&Reset"));
    ...
    sizerMiddle->Add(CreateSizerWithTextAndButton(CheckboxPage_ChangeLabel,
                                                     ...
                                                     &m_textLabel),
                     0, wxALL | wxGROW, 5);
    sizerMiddle->Add(new wxButton(this, CheckboxPage_Check, wxT_2("&Check it")),
                     0, wxALL | wxGROW, 5);
    sizerMiddle->Add(new wxButton(this, CheckboxPage_Uncheck, wxT_2("&Uncheck it")),
                     0, wxALL | wxGROW, 5);
    sizerMiddle->Add(new wxButton(this, CheckboxPage_PartCheck,
                                  wxT_2("Put in &3rd state")),
                     0, wxALL | wxGROW, 5);

    // right pane
    wxSizer *sizerRight = new wxBoxSizer(wxHORIZONTAL);
    m_checkbox = new wxCheckBox(this, CheckboxPage_Checkbox, wxT_2("&Check me!"));
...
{
    wxLogMessage(wxT_2("Test checkbox %schecked (value = %d)."),
                 event.IsChecked() ? wxT_2("") : wxT_2("un"),
