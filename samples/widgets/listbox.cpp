...
IMPLEMENT_WIDGETS_PAGE(ListboxWidgetsPage, wxS("Listbox"),
...
void ListboxWidgetsPage::CreateContent()
{
    ...
    */
    ...
    m_radioSelMode = new wxRadioBox(this, wxID_ANY, wxT_2("Selection &mode:"),
    ...
    m_chkVScroll = CreateCheckBoxAndAddToSizer
                   (
                    sizerLeft,
                    wxT_2("Always show &vertical scrollbar")
                   );
    m_chkHScroll = CreateCheckBoxAndAddToSizer
                   (
                    sizerLeft,
                    wxT_2("Show &horizontal scrollbar")
                   );
    m_chkSort = CreateCheckBoxAndAddToSizer(sizerLeft, wxT_2("&Sort items"));
    m_chkOwnerDraw = CreateCheckBoxAndAddToSizer(sizerLeft, wxT_2("&Owner drawn"));
    ...
    wxButton *btn = new wxButton(this, ListboxPage_Reset, wxT_2("&Reset"));
    sizerLeft->Add(btn, 0, wxALIGN_CENTRE_HORIZONTAL | wxALL, 15);

    // middle pane
    wxStaticBox *box2 = new wxStaticBox(this, wxID_ANY,
        wxT_2("&Change listbox contents"));
    wxSizer *sizerMiddle = new wxStaticBoxSizer(box2, wxVERTICAL);

    wxSizer *sizerRow = new wxBoxSizer(wxHORIZONTAL);
    btn = new wxButton(this, ListboxPage_Add, wxT_2("&Add this string"));
    m_textAdd = new wxTextCtrl(this, ListboxPage_AddText, wxT_2("test item 0"));
    sizerRow->Add(btn, 0, wxRIGHT, 5);
    sizerRow->Add(m_textAdd, 1, wxLEFT, 5);
    sizerMiddle->Add(sizerRow, 0, wxALL | wxGROW, 5);

    btn = new wxButton(this, ListboxPage_AddSeveral, wxT_2("&Insert a few strings"));
    sizerMiddle->Add(btn, 0, wxALL | wxGROW, 5);

    btn = new wxButton(this, ListboxPage_AddMany, wxT_2("Add &many strings"));
    sizerMiddle->Add(btn, 0, wxALL | wxGROW, 5);

    sizerRow = new wxBoxSizer(wxHORIZONTAL);
    btn = new wxButton(this, ListboxPage_Change, wxT_2("C&hange current"));
    ...
    sizerRow = new wxBoxSizer(wxHORIZONTAL);
    btn = new wxButton(this, ListboxPage_EnsureVisible, wxT_2("Make item &visible"));
    ...
    sizerRow = new wxBoxSizer(wxHORIZONTAL);
    btn = new wxButton(this, ListboxPage_Delete, wxT_2("&Delete this item"));
    m_textDelete = new wxTextCtrl(this, ListboxPage_DeleteText, wxEmptyString);
    sizerRow->Add(btn, 0, wxRIGHT, 5);
    sizerRow->Add(m_textDelete, 1, wxLEFT, 5);
    sizerMiddle->Add(sizerRow, 0, wxALL | wxGROW, 5);

    btn = new wxButton(this, ListboxPage_DeleteSel, wxT_2("Delete &selection"));
    sizerMiddle->Add(btn, 0, wxALL | wxGROW, 5);

    btn = new wxButton(this, ListboxPage_Clear, wxT_2("&Clear"));
    sizerMiddle->Add(btn, 0, wxALL | wxGROW, 5);

    btn = new wxButton(this, ListboxPage_MoveUp, wxT_2("Move item &up"));
    sizerMiddle->Add(btn, 0, wxALL | wxGROW, 5);

    btn = new wxButton(this, ListboxPage_MoveDown, wxT_2("Move item &down"));
    sizerMiddle->Add(btn, 0, wxALL | wxGROW, 5);

    btn = new wxButton(this, ListboxPage_GetTopItem, wxT_2("Get top item"));
    sizerMiddle->Add(btn, 0, wxALL | wxGROW, 5);

    btn = new wxButton(this, ListboxPage_GetCountPerPage, wxT_2("Get count per page"));
    sizerMiddle->Add(btn, 0, wxALL | wxGROW, 5);

    btn = new wxButton(this, ListboxPage_ContainerTests, wxT_2("Run &tests"));
    sizerMiddle->Add(btn, 0, wxALL | wxGROW, 5);
...
void ListboxWidgetsPage::CreateLbox()
{
    ...
    {
        default:
            wxFAIL_MSG( wxT_2("unexpected radio box selection") );
            wxFALLTHROUGH;
...
void ListboxWidgetsPage::OnButtonAddMany(wxCommandEvent& WXUNUSED(event))
{
    ...
    {
        m_lbox->Append(wxString::Format(wxT_2("item #%u"), n));
    }
}
...
{
    wxArrayString items;
    items.Add(wxT_2("First"));
    items.Add(wxT_2("another one"));
    items.Add(wxT_2("and the last (very very very very very very very very very very long) one"));
...
void ListboxWidgetsPage::OnListbox(wxCommandEvent& event)
{
    ...
    {
        wxLogMessage(wxT_2("Listbox item %ld selected"), sel);
    }
    else
    {
        wxLogMessage(wxT_2("Listbox item %ld deselected"), sel);
    }
}

void ListboxWidgetsPage::OnListboxDClick(wxCommandEvent& event)
{
    wxLogMessage( wxT_2("Listbox item %d double clicked"), event.GetInt() );
}

void ListboxWidgetsPage::OnCheckListbox(wxCommandEvent& event)
{
    wxLogMessage( wxT_2("Listbox item %d toggled"), event.GetInt() );
}
