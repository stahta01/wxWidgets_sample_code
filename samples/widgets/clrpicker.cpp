...
IMPLEMENT_WIDGETS_PAGE(ColourPickerWidgetsPage, wxS("ColourPicker"),
...
void ColourPickerWidgetsPage::CreateContent()
{
    ...
    wxStaticBoxSizer *clrbox = new wxStaticBoxSizer(wxVERTICAL, this, wxT_2("&ColourPicker style"));
    m_chkColourTextCtrl = CreateCheckBoxAndAddToSizer(clrbox, wxT_2("With textctrl"));
    m_chkColourShowLabel = CreateCheckBoxAndAddToSizer(clrbox, wxT_2("With label"));
    m_chkColourShowAlpha = CreateCheckBoxAndAddToSizer(clrbox, wxT_2("With opacity"));
...
{
    wxLogMessage(wxT_2("The colour changed to '%s' !"),
