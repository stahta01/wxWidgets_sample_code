...
IMPLEMENT_WIDGETS_PAGE(ChoiceWidgetsPage, wxS("Choice"),
...
void ChoiceWidgetsPage::CreateContent()
{
    ...
    */
    ...
    wxStaticBox *box = new wxStaticBox(this, wxID_ANY,
        wxT_2("&Set choice parameters"));
    wxSizer *sizerLeft = new wxStaticBoxSizer(box, wxVERTICAL);

    m_chkSort = CreateCheckBoxAndAddToSizer(sizerLeft, wxT_2("&Sort items"));

    wxButton *btn = new wxButton(this, ChoicePage_Reset, wxT_2("&Reset"));
    sizerLeft->Add(btn, 0, wxALIGN_CENTRE_HORIZONTAL | wxALL, 15);

    // middle pane
    wxStaticBox *box2 = new wxStaticBox(this, wxID_ANY,
        wxT_2("&Change choice contents"));
    wxSizer *sizerMiddle = new wxStaticBoxSizer(box2, wxVERTICAL);

    wxSizer *sizerRow = new wxBoxSizer(wxHORIZONTAL);
    btn = new wxButton(this, ChoicePage_Add, wxT_2("&Add this string"));
    m_textAdd = new wxTextCtrl(this, ChoicePage_AddText, wxT_2("test item 0"));
    sizerRow->Add(btn, 0, wxRIGHT, 5);
    sizerRow->Add(m_textAdd, 1, wxLEFT, 5);
    sizerMiddle->Add(sizerRow, 0, wxALL | wxGROW, 5);

    btn = new wxButton(this, ChoicePage_AddSeveral, wxT_2("&Insert a few strings"));
    sizerMiddle->Add(btn, 0, wxALL | wxGROW, 5);

    btn = new wxButton(this, ChoicePage_AddMany, wxT_2("Add &many strings"));
    sizerMiddle->Add(btn, 0, wxALL | wxGROW, 5);

    sizerRow = new wxBoxSizer(wxHORIZONTAL);
    btn = new wxButton(this, ChoicePage_Change, wxT_2("C&hange current"));
    ...
    sizerRow = new wxBoxSizer(wxHORIZONTAL);
    btn = new wxButton(this, ChoicePage_Delete, wxT_2("&Delete this item"));
    m_textDelete = new wxTextCtrl(this, ChoicePage_DeleteText, wxEmptyString);
    sizerRow->Add(btn, 0, wxRIGHT, 5);
    sizerRow->Add(m_textDelete, 1, wxLEFT, 5);
    sizerMiddle->Add(sizerRow, 0, wxALL | wxGROW, 5);

    btn = new wxButton(this, ChoicePage_DeleteSel, wxT_2("Delete &selection"));
    sizerMiddle->Add(btn, 0, wxALL | wxGROW, 5);

    btn = new wxButton(this, ChoicePage_Clear, wxT_2("&Clear"));
    sizerMiddle->Add(btn, 0, wxALL | wxGROW, 5);

    btn = new wxButton(this, ChoicePage_ContainerTests, wxT_2("Run &tests"));
    sizerMiddle->Add(btn, 0, wxALL | wxGROW, 5);
...
void ChoiceWidgetsPage::OnButtonAddMany(wxCommandEvent& WXUNUSED(event))
{
    ...
    {
        strings.Add(wxString::Format(wxT_2("item #%u"), n));
    }
...
void ChoiceWidgetsPage::OnChoice(wxCommandEvent& event)
{
    ...
    wxLogMessage(wxT_2("Choice item %ld selected"), sel);
}
